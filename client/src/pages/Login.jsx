            ...
            <div className="bg-grey-100 border-1 p-8 rounded-2xl shadow-lg text-black backdrop-blur-xs">
                ...
                <form className="flex flex-col w-[70vh] gap-4 " onSubmit={handleSubmit}>
                    <div className="flex flex-col pb-5">
                        ...
                        <input type="text" id="username" name="username" required className=" pl-8 rounded-lg h-10"
                        onChange={ e => setUsername(e.target.value)}/>
                    </div>
                    <div className="flex flex-col pb-1">
                        <label htmlFor="password" className="text-left">Password</label>
                        <input type="password" id="password" name="password" required className="pl-8 rounded-lg h-10"
